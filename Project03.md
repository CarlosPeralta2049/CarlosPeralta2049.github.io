...
<br>
## Sensitivity Analysis: Trade and Tariffs
...
The U.S. gains consistently (and the most) from tariff reductions on its exports, the study also reveales that a 10% tariff cut on U.S. imports is the most beneficial combination for the world. However, these simulations give the results of a snapshot in time and do not reflect their use in a wider context. Large countries like the U.S. (where 'large' describes a country whose demand levels affect global prices) have a special advantage in global trade. Beyond waiting for others to reduce their tariffs for U.S. exports, the U.S. can introduce import tariffs also as retiliation to the existing tariffs on its exports. It would be wise to consider that domestic income is far greater than global trade income. The U.S. may intrduce import tariffs to flush inefficient aspects of the economy, trigger recessionary fears, force the Federal Reserve Bank to lower interest rates, allowing government to refinance its national debt at low rates, then stimulating the economy. For the long run, governments have choises and national debt sustainability may be prioritised over global growth.
