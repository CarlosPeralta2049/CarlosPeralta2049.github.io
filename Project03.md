...
The U.S. gains consistently (and the most) from tariff reductions on its exports. This study revealed that a 10% tariff cut is the most beneficial combination for the world. However, these simulations give the results of a snapshot in time and do not reflect the use of as a response to other tariffs or strategically to gain long term benefits. Large countries like the U.S. (where 'large' describes a country whose demand levels affect global prices) have a special advantage in global trade. Beyond waiting for others to reduce their tariffs for U.S. exports, the U.S. can introduce import tariffs also as retiliation to it existing tariffs on its exports. Overall income from trade may be less than the income from stimulating the economy. The U.S. may simply intrduce import tariffs to flush inefficient aspects ot the economy, force the Federal Reserve Bank to lower interest rates, allow government to refinance its national debt at low rates, and stimulate the economy. For the long run, national debt sustainability may be the priority, then global growth.
