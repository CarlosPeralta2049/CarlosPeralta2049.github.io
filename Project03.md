...
The U.S. gains the most, and consistently tariff reductions on its exports.
World trade gains with a 49.1% increase as U.S. export tariffs are removed.
Generally, a 10% tariff cut is the most beneficial combination for the world.
However, these simulations give the general results of a snapshot in time.
Large importers like the U.S. can potentially benefit from tariffs.
However, as they place tariffs retaliation and trade wars may rise.
...
As part of the secondary objective...


With regards to economic correlations and the importance of trade liberalization efforts, the dynamic data analysis here finds a relationship between Trade as a Percentage of GDP and GDP from 1971 to 2022. Here, the statistical relationship between the variables interprets that the direction is positive, and its coefficient identifies that the strength of the relationship between the variables was very strong. Because the coefficient measures relationships with values between –1 and –1. -1 describes that there is no relationship between the variables, and 1 confirms that there is a strong relationship. We can interpret that because the correlation coefficient is very high at 0.94. Hence, it is with confidence this analysis finds that an increase in the European Union’s balance of trade is very likely to increase Gross Domestic Product, resulting with greater economic benefits for all on average, over time. 
