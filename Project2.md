...
In the ideal scenario, government spending and all inflation would occur at the same time as currency depreciation, following interest rate reductions and capital outflows. Asset prices would continiously rise as long as interest rate increases are not announced. The situation temporarily makes the USD an inferior asset, relatively. Coupled with the compounding effect of luxury asset volatility and leveraged borrowing here we find the highest levels of risk and reward.
